...
@Entity
@Table(name = "cliente", schema = "no_appearance", catalog = "")
public class ClienteEntity {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(idCliente, nombre, apellido, nacimiento, correo, contrasena, txId, txHost, txUser, txDate, txUpdate);
    }
}
