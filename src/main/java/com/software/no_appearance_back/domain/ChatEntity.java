...
@Entity
@Table(name = "chat", schema = "no_appearance", catalog = "")
public class ChatEntity {
    ...
    public boolean equals(Object o) {
        ...
        return idChat == that.idChat && idCliente1 == that.idCliente1 && idCliente2 == that.idCliente2 && estado == that.estado && txId == that.txId && txUser == that.txUser && Objects.equals(txHost, that.txHost) && Objects.equals(txDate, that.txDate) && Objects.equals(txUpdate, that.txUpdate);
    }

    @Override
    public int hashCode() {
        return Objects.hash(idChat, idCliente1, idCliente2, estado, txId, txHost, txUser, txDate, txUpdate);
    }
}
